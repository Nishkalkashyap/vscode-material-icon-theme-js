...
// const iconsJSONFile = readFileSync('./node_modules/vscode-icons-js/data/generated/icons.json');
const iconsJSONFile = readFileSync('./scripts/material-icons.json');
const vsiLanguagesFile = readFileSync('./node_modules/vscode-icons-js/data/generated/languages-vsi.json');
...
icons.light.folderNames = Object.assign(icons.folderNames, icons.light.folderNames);
icons.light.fileExtensions = Object.assign(icons.fileExtensions, icons.light.fileExtensions);
icons.light.fileNames = Object.assign(icons.fileNames, icons.light.fileNames);
icons.light.languageIds = Object.assign(icons.languageIds, icons.light.languageIds);
...
(async function () {
    ...
    fss.ensureFileSync(PATH_ICONSDATA + 'FolderNamesToIcon.ts');
...
(async function () {
    ...
    fss.ensureFileSync(PATH_ICONSDATA + 'FileExtensions1ToIcon.ts');
    fss.ensureFileSync(PATH_ICONSDATA + 'FileExtensions2ToIcon.ts');
...
(async function () {
    ...
    fss.ensureFileSync(PATH_ICONSDATA + 'FileNamesToIcon.ts');
...
(async function () {
    ...
    fss.ensureFileSync(PATH_ICONSDATA + 'LanguagesToIcon.ts');
